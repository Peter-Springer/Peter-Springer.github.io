      ...
      <section id="code">
        ...
        <section className="code-sample">
          <article className="code-sample-info">
            <a target="_blank" href="https://github.com/Peter-Springer/turing-fridays">
              <h1 className="card-headers">TURING FRIDAYS</h1>
            </a>
            <p>Tech Stack</p>
            <ul>
              <li>React</li>
          ...
          <a target="_blank" href="https://turing-fridays.firebaseapp.com/">
          <img className="cards" src="../img/turing-fridays.gif"/>
          </a>
        </section>
        <section className="code-sample">
          <img className="cards" src="../img/notes.gif"/>
          <article className="code-sample-info-chat">
            <a target="_blank" href="https://github.com/Peter-Springer/electron-project">
        ...
        <section className="code-sample">
          ...
          <a target="_blank" href="http://peterspringer.net/game-time">
        ...
        <section className="code-sample">
          ...
          <a target="_blank" href="http://peterspringer.net/pomodoro-app">
          <img className="cards gif5" src="../img/pomodoro.gif"/>
          </a>
        </section>
      </section>
    )
